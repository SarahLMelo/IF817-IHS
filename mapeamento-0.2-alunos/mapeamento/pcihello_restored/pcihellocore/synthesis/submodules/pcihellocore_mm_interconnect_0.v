...
module pcihellocore_mm_interconnect_0 (
	...
	wire  [112:0] display_s1_agent_rp_data;                                               // display_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [112:0] switches_s1_agent_rp_data;                                              // switches_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [112:0] router_004_src_data;                                                    // router_004:src_data -> display_s1_rsp_width_adapter:in_data
	wire          router_004_src_ready;                                                   // display_s1_rsp_width_adapter:in_ready -> router_004:src_ready
	wire    [7:0] router_004_src_channel;                                                 // router_004:src_channel -> display_s1_rsp_width_adapter:in_channel
	...
	wire  [148:0] display_s1_rsp_width_adapter_src_data;                                  // display_s1_rsp_width_adapter:out_data -> rsp_demux_003:sink_data
	wire          display_s1_rsp_width_adapter_src_ready;                                 // rsp_demux_003:sink_ready -> display_s1_rsp_width_adapter:out_ready
	wire    [7:0] display_s1_rsp_width_adapter_src_channel;                               // display_s1_rsp_width_adapter:out_channel -> rsp_demux_003:sink_channel
	...
	wire  [112:0] router_006_src_data;                                                    // router_006:src_data -> switches_s1_rsp_width_adapter:in_data
	wire          router_006_src_ready;                                                   // switches_s1_rsp_width_adapter:in_ready -> router_006:src_ready
	wire    [7:0] router_006_src_channel;                                                 // router_006:src_channel -> switches_s1_rsp_width_adapter:in_channel
	...
	wire  [148:0] switches_s1_rsp_width_adapter_src_data;                                 // switches_s1_rsp_width_adapter:out_data -> rsp_demux_005:sink_data
	wire          switches_s1_rsp_width_adapter_src_ready;                                // rsp_demux_005:sink_ready -> switches_s1_rsp_width_adapter:out_ready
	wire    [7:0] switches_s1_rsp_width_adapter_src_channel;                              // switches_s1_rsp_width_adapter:out_channel -> rsp_demux_005:sink_channel
	...
	wire          router_007_src_valid;                                                   // router_007:src_valid -> led_s1_rsp_width_adapter:in_valid
	wire  [112:0] router_007_src_data;                                                    // router_007:src_data -> led_s1_rsp_width_adapter:in_data
	wire          router_007_src_ready;                                                   // led_s1_rsp_width_adapter:in_ready -> router_007:src_ready
	wire    [7:0] router_007_src_channel;                                                 // router_007:src_channel -> led_s1_rsp_width_adapter:in_channel
	wire          router_007_src_startofpacket;                                           // router_007:src_startofpacket -> led_s1_rsp_width_adapter:in_startofpacket
	wire          router_007_src_endofpacket;                                             // router_007:src_endofpacket -> led_s1_rsp_width_adapter:in_endofpacket
	wire          led_s1_rsp_width_adapter_src_valid;                                     // led_s1_rsp_width_adapter:out_valid -> rsp_demux_006:sink_valid
	wire  [148:0] led_s1_rsp_width_adapter_src_data;                                      // led_s1_rsp_width_adapter:out_data -> rsp_demux_006:sink_data
	wire          led_s1_rsp_width_adapter_src_ready;                                     // rsp_demux_006:sink_ready -> led_s1_rsp_width_adapter:out_ready
	wire    [7:0] led_s1_rsp_width_adapter_src_channel;                                   // led_s1_rsp_width_adapter:out_channel -> rsp_demux_006:sink_channel
	wire          led_s1_rsp_width_adapter_src_startofpacket;                             // led_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_006:sink_startofpacket
	wire          led_s1_rsp_width_adapter_src_endofpacket;                               // led_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_006:sink_endofpacket
	...
	wire  [148:0] cmd_mux_003_src_data;                                                   // cmd_mux_003:src_data -> display_s1_cmd_width_adapter:in_data
	wire          cmd_mux_003_src_ready;                                                  // display_s1_cmd_width_adapter:in_ready -> cmd_mux_003:src_ready
	wire    [7:0] cmd_mux_003_src_channel;                                                // cmd_mux_003:src_channel -> display_s1_cmd_width_adapter:in_channel
	...
	wire  [148:0] cmd_mux_005_src_data;                                                   // cmd_mux_005:src_data -> switches_s1_cmd_width_adapter:in_data
	wire          cmd_mux_005_src_ready;                                                  // switches_s1_cmd_width_adapter:in_ready -> cmd_mux_005:src_ready
	wire    [7:0] cmd_mux_005_src_channel;                                                // cmd_mux_005:src_channel -> switches_s1_cmd_width_adapter:in_channel
	...
	wire          cmd_mux_006_src_valid;                                                  // cmd_mux_006:src_valid -> led_s1_cmd_width_adapter:in_valid
	wire  [148:0] cmd_mux_006_src_data;                                                   // cmd_mux_006:src_data -> led_s1_cmd_width_adapter:in_data
	wire          cmd_mux_006_src_ready;                                                  // led_s1_cmd_width_adapter:in_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                                // cmd_mux_006:src_channel -> led_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_006_src_startofpacket;                                          // cmd_mux_006:src_startofpacket -> led_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                            // cmd_mux_006:src_endofpacket -> led_s1_cmd_width_adapter:in_endofpacket
	wire          led_s1_cmd_width_adapter_src_valid;                                     // led_s1_cmd_width_adapter:out_valid -> led_s1_burst_adapter:sink0_valid
	wire  [112:0] led_s1_cmd_width_adapter_src_data;                                      // led_s1_cmd_width_adapter:out_data -> led_s1_burst_adapter:sink0_data
	wire          led_s1_cmd_width_adapter_src_ready;                                     // led_s1_burst_adapter:sink0_ready -> led_s1_cmd_width_adapter:out_ready
	wire    [7:0] led_s1_cmd_width_adapter_src_channel;                                   // led_s1_cmd_width_adapter:out_channel -> led_s1_burst_adapter:sink0_channel
	wire          led_s1_cmd_width_adapter_src_startofpacket;                             // led_s1_cmd_width_adapter:out_startofpacket -> led_s1_burst_adapter:sink0_startofpacket
	wire          led_s1_cmd_width_adapter_src_endofpacket;                               // led_s1_cmd_width_adapter:out_endofpacket -> led_s1_burst_adapter:sink0_endofpacket
	...
	altera_merlin_burst_adapter #(
		...
		.clk                   (pcie_hard_ip_0_pcie_core_clk_clk),           //       cr0.clk
		.reset                 (inport_reset_reset_bridge_in_reset_reset),   // cr0_reset.reset
		.sink0_valid           (led_s1_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (led_s1_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (led_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (led_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (led_s1_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (led_s1_cmd_width_adapter_src_ready),         //          .ready
